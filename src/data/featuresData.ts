...
const features_data: DataType[] = [
...

   {
      ...
      desc:"Expert home cleaning tailored to your schedule — regular, deep and move-out cleans.",
   },
   {
      id:2,
      page:"home_2",
      icon_name:"flaticon-office",
      title:"Commercial Cleaning",
      desc:"Reliable cleaning services for offices and businesses with flexible plans.",
      item_bg:"feature-item--green",
   },
   {
      id:3,
      page:"home_2",
      icon_name:"flaticon-spraying",
      title:"Deep &amp; Specialized Cleaning",
      desc:"Deep cleans, sanitization, and specialized treatments using eco-friendly products.",
